 ...
 */
contract OpenpadPaymentSplitter is Context, AccessControl  {
     ...
     */
    function _addPayee(address account, uint256 shares_) public onlyRole(PROJECT_SALE) {
    ...
    function _updateShares(address account, uint256 shares_) public onlyRole(PROJECT_SALE) {
        //require(shares_ > 0, "PaymentSplitter: shares are 0");
        require(_shares[account] > 0, "PaymentSplitter: account has no shares");
